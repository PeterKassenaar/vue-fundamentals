            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <router-link to="/api" class="nav-link" exact>Country API - direct http</router-link>
                        </li>
                        <li class="nav-item">
                            <router-link to="/vuex" class="nav-link" exact>Country API - vuex</router-link>
                        </li>
                    </ul>
                </div>
            </nav>
...
<style scoped>
    /*resize to logo to fit in the navbar*/
    .navbar-brand img {
        width: 40px;
        height: 40px;
    }
